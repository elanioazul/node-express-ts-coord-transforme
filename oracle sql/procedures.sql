...
INSERT INTO COORDINATES_INITIAL VALUES (DEFAULT, 1.493404, 41.631894, 4258)
INSERT INTO COORDINATES_INITIAL VALUES (DEFAULT, 1.395264, 42.313878, 4258)
INSERT INTO COORDINATES_INITIAL VALUES (DEFAULT, 2.147827, 41.590797, 4258)
...
INSERT INTO COORDINATES_SYSTEMS (epsg, epsg_desc, label, label_advance) VALUES (4326, 'EPSG 4326 - WGS84', 'gps grados, minutos y segundos', 'WGS84 Geograficas (4326) GMS');
INSERT INTO COORDINATES_SYSTEMS (epsg, epsg_desc, label, label_advance) VALUES (4326, 'EPSG 4326 - WGS84', 'gps grados decimales', 'WGS84 Geograficas (4326) GD');
INSERT INTO COORDINATES_SYSTEMS (epsg, epsg_desc, label, label_advance) VALUES (3857, 'EPSG:3857 - WGS 84', 'x e y psudomercator (metros)', 'WGS84 PsueudoMercator(3857)');
INSERT INTO COORDINATES_SYSTEMS (epsg, epsg_desc, label, label_advance) VALUES (23031, 'EPSG:23031 - ED50 / UTM zone 31N', 'ed50 utm (metros)', 'ED50 / UTM zone 31N');
INSERT INTO COORDINATES_SYSTEMS (epsg, epsg_desc, label, label_advance) VALUES (4258, 'EPSG:4258 - ETRS89', 'etrs89 geograficas grados decimales', 'ETRS Geograficas (4258) GD');
INSERT INTO COORDINATES_SYSTEMS (epsg, epsg_desc, label, label_advance) VALUES (4258, 'EPSG:4258 - ETRS89', 'etrs89 geograficas grados, minutos y segundos', 'ETRS Geograficas (4258) GMS');
INSERT INTO COORDINATES_SYSTEMS (epsg, epsg_desc, label, label_advance) VALUES (25831, 'EPSG:25831 - ETRS89 / UTM zone 31N', 'etrs89 catalunya proyectadas (metros)', 'ETRS89 UTM huso 31N (25831)');
